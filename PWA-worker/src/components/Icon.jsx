...
const icons = {
  ...
  fingerprint: <><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0110 10"/><path d="M5 19.5C5.5 18 6 15 6 12c0-3.3 2.7-6 6-6"/><path d="M17.8 13c.2-.8.2-1.5.2-2 0-2.2-1.8-4-4-4"/><path d="M12 20c-.3-1.2-1-2.7-2.5-4.5"/><path d="M9 21c0-.8.5-2 1.5-3"/><path d="M15 21c1-2 1.5-3.5 1.5-5.5 0-1.9-1.5-3.5-3.5-3.5"/></>,
  ...
  payouts: <><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></>,
